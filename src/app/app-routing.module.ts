...
const routes: Routes = [
  {path:"admin", loadChildren:()=>import("./Module/admin/admin-routing.module").then
  (m=>AdminRoutingModule)},   //loadChildren() return promise
...
@NgModule({
  imports: [RouterModule.forRoot(routes)], //forroot use when we create ADMIN panel //Parent Routing //will create ADMIN with routing file(ng g m admin --routing)
